...
class Compiler:
    ...
    def _get_registers(self, ir3_node: Assignment3Node) -> Any:
    ...
    def _convert_stmt_to_assembly(self, ir3_node: Any) -> "Instruction":
        ...
        while not completed:
            ...
            if type(current_stmt) == PrintLn3Node:
                ...
                registers = self._get_registers(current_stmt)
